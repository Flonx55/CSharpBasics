...
namespace _29飞行棋
{
    class Program
    {
        ...
        //两个玩家的标记
        public static bool[] Flags = new bool[2];//Flags[0]默认是false Flags[1]默认也是false
        static void Main(string[] args)
        {
            ...
            InitialMap();
            //2,初始化地图:将整数数组中的数字编程控制台中显示的特殊字符串的这个过程
            DrawMap();
        ...
        public static void GameShow()
        {
            ...
            Console.WriteLine("************************************************************************************************************************");
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("*************************************************LYS硬核飞行棋--v1.0****************************************************");
            Console.WriteLine("************************************************************************************************************************");
                    ...
                    case 1:
                        ...
                        while (true)
                        {
                            ...
                            else if (input == "2")
                            {
                                ...
                                ChangePos();
                                Console.ReadKey(true);
                                Console.WriteLine("玩家{}退了6格", PlayerNames[1 - playerNumber]);
                                Console.ReadKey(true);
                                break;
                            }
                            else
